...
from api.v1.base_models.common.address.serializers import AddressSerializer, CUSTOM_FIELD_SCHEMA
...
class TestAddressSerializer:
    ...
    def test_serializer_representation(self):
        ...
        assert representation['country'] == {'code': 'US', 'name': 'United States of America'}
    ...
    def test_custom_fields_validation_max_length(self):
        ...
        data = {
            ...
            'country': 'US',
            'custom_fields': {
                'floor': 'a' * 11  # Exceeds max_length of 10
            }
        }
        serializer = AddressSerializer(data=data)
        assert not serializer.is_valid()
        ...
        assert 'cannot exceed 10 characters' in str(serializer.errors['custom_fields'][0])
